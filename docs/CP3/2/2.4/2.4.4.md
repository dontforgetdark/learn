...
Ban đầu ta có 1 chuỗi S và Q truy vấn

- Truy vấn 1: xóa các kí tự từ l -> r
- Truy vấn 2: in ra chuỗi con từ l -> r

*Đề đảm bảo vị trí xóa là đúng và tống số lượng kí tự dc xóa <= |s|. Tổng số kí tự in cũng không quá |s|. Chỉ số s tính từ 1.*
